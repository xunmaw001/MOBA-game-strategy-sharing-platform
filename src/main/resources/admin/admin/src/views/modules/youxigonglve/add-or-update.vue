<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="游戏类型" prop="youxileixing">
        ...
        <div v-else>
          <el-form-item class="input" label="游戏类型" prop="youxileixing">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="英雄类型" prop="yingxiongleixing">
          <el-select :disabled="ro.yingxiongleixing" v-model="ruleForm.yingxiongleixing" placeholder="请选择英雄类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="英雄类型" prop="yingxiongleixing">
	      <el-input v-model="ruleForm.yingxiongleixing"
                placeholder="英雄类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="攻略" prop="gonglve">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gonglve" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gonglve" label="攻略" prop="gonglve">
                    <span v-html="ruleForm.gonglve"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxileixing = true;
          ...
          if(o=='yingxiongleixing'){
            this.ruleForm.yingxiongleixing = obj[o];
	    this.ro.yingxiongleixing = true;
            continue;
          }
          if(o=='gonglve'){
            this.ruleForm.gonglve = obj[o];
	    this.ro.gonglve = true;
            continue;
          }
          if(o=='shipin'){
	...
	this.ruleForm.gonglve = this.ruleForm.gonglve.replace(reg,'../../../springbootf34cq/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
