...
public class YouxigonglveModel  implements Serializable {
	...
	private String yingxiongleixing;
	...
	public void setYingxiongleixing(String yingxiongleixing) {
		this.yingxiongleixing = yingxiongleixing;
	}
	
	/**
	 * 获取：英雄类型
	 */
	public String getYingxiongleixing() {
		return yingxiongleixing;
	}
	...
	public void setGonglve(String gonglve) {
